...
load(fullfile(param_root, 'MiuofAl.mat'), 'MiuofAl')
load(fullfile(param_root, 'MiuofCo.mat'), 'MiuofCo')
load(fullfile(param_root, 'MiuofW.mat'), 'MiuofW')
load(fullfile(param_root, 'MiuofCr.mat'), 'MiuofCr')
load(fullfile(param_root, 'MiuofCr19Ni10.mat'), 'MiuofCr19Ni10')
...
MiuofMetal(:, :, 5) = MiuofAl(1:kVp, :);
MiuofMetal(:, :, 6) = MiuofCo(1:kVp, :);
MiuofMetal(:, :, 7) = MiuofW(1:kVp, :);
MiuofMetal(:, :, 8) = MiuofCr(1:kVp, :);
MiuofMetal(:, :, 9) = MiuofCr19Ni10(1:kVp, :);

densityMetal = [4.5 7.8 8.9 19.3 2.7 8.86 19.35 7.15 7.93];
